<script lang="ts">
	...
	let loginDialog: boolean = false;
</script>

<div class="bb m-2 mx-4 ">
	<nav class="bb flex items-center text-lg font-semibold">
		<div class="bb m-1">
			<a href="/" class="flex items-center">
				...
				>
				<span class="bb p-1 pl-2">ТУХЛА</span>
			</a>
		</div>
		<ul class="bb flex flex-auto items-center space-x-12 p-1 pl-48">
			<li class="bb">
				<a class="bb p-3 hover:rounded-full hover:border-none hover:bg-blue-300" href="/buy"
					>продажби</a
				>
			</li>
			<li class="bb">
				<a class="bb p-3 hover:rounded-full hover:border-none hover:bg-blue-300" href="/sell"
					>наеми</a
				>
			</li>
			<li class="bb">
				<a class="bb p-3 hover:rounded-full hover:border-none hover:bg-blue-300" href="/evaluate"
					>оценки</a
				>
			</li>
		</ul>
		<button
			class="bb m-1 mr-12 flex items-center justify-center p-3 hover:rounded-full hover:border-none hover:bg-blue-300"
			on:click={(e) => {
				loginDialog = !loginDialog;
			}}
		>
			<svg class="bb h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
				<path
					d="M10 8a3 3 0 100-6 3 3 0 000 6zM3.465 14.493a1.23 1.23 0 00.41 1.412A9.957 9.957 0 0010 18c2.31 0 4.438-.784 6.131-2.1.43-.333.604-.903.408-1.41a7.002 7.002 0 00-13.074.003z"
				/>
			</svg>
			<span class="bb m-1">влез</span>
		</button>
	</nav>
	<hr />
</div>

<div class="bb m-2 flex items-center justify-center {loginDialog ? '' : 'hidden'}">
	<Login />
</div>
